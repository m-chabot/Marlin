...
#define STRING_CONFIG_H_AUTHOR "(MC, ender3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender 3 BigTreeTech"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 99.44
  #define DEFAULT_bedKi 16.1
  #define DEFAULT_bedKd 409.21
